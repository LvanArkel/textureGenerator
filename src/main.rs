...
fn main() -> () {
    ...
    let node1 = Node::new(String::from("Solid red"), Box::new(SolidColor{color: Rgb([1.0, 0.0, 0.0])}));
    let node2 = Node::new(String::from("Solid Green"), Box::new(SolidColor{color: Rgb([0.0, 1.0, 0.0])}));
