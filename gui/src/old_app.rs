use std::{borrow::Cow, collections::HashMap, cell::{Ref, RefCell}};
...
pub struct MyNodeData {
    ...
    cached: Option<RefCell<MyValueType>>
}
...
impl NodeTemplateTrait for MyNodeTemplate {
    ...
    fn user_data(&self, _user_state: &mut Self::UserState) -> Self::NodeData {
        MyNodeData { template: *self, cached: None }
    }
...
impl NodeDataTrait for MyNodeData {
        ...
        MyResponse: UserResponseTrait,
    {
        ...
        match evaluate_node(graph, node_id, &mut HashMap::new()) {
            Ok(mut value) => {value.value_widget("res", node_id, ui, user_state, &graph[node_id].user_data);},
            Err(_) => {},
        };
